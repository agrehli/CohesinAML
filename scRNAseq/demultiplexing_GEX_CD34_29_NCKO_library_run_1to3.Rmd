...
```{r,eval=T,echo=FALSE}
# Paths
sample <- "GEX_CD34_29_NCKO_library_run_1to3"
path_to_data <- str_c(
...
## Sample 1: scRNA_GEX_CD34_29_NC
## Sample 2: scRNA_GEX_CD34_29_KO
...
Let us visualize the numbers of singlets/doublets/negative  and compare number of UMIs:
