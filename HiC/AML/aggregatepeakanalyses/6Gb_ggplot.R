...
# Define names: Cohesin project - CD34 model - merged matrices
...
# 6G - Subpanel B - Every CD34 sample - not split by distance
	cd34.b.df <- cd34.df %>%
				filter(
	...
	q2 <- qplot(data=cd34.b.df, x=Var1, y=Var2,
		...
		ggsave(paste0(printdir,'6G_CD34model.png'),
			q2, width = 24, height = 10, dpi=600, units='cm')
		ggsave(paste0(printdir,'6G_CD34model.pdf'),
